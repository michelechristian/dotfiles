...
globalkeys = gears.table.join(
    ...
    -- launch rofi
    awful.key({modkey}, "d", function () awful.spawn("rofi -show drun -modi drun -show-icons -columns 2") end,
        {description = "Launch Rofi", group="launcher"}
    ),
    
    -- launch window switcher
    awful.key({modkey}, "slash", function () awful.spawn("rofi -show window -show-icons") end,
